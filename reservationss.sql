...
--
-- Hôte : 127.0.0.1
-- Généré le : jeu. 16 juin 2022 à 21:10
...
(1, '1.1', 'create artists table', 'SQL', 'V1_1__create_artists_table.sql', -1928428595, 'root', '2022-06-16 18:48:11', 53, 1),
(2, '1.2', 'insert artists table', 'SQL', 'V1_2__insert_artists_table.sql', -280175186, 'root', '2022-06-16 18:48:11', 7, 1),
(3, '2.1', 'create types table', 'SQL', 'V2_1__create_types_table.sql', 1925872095, 'root', '2022-06-16 18:48:11', 70, 1),
(4, '2.2', 'insert types table', 'SQL', 'V2_2__insert_types_table.sql', -126045216, 'root', '2022-06-16 18:48:11', 7, 1),
(5, '3.1', 'create localities table', 'SQL', 'V3_1__create_localities_table.sql', 175429460, 'root', '2022-06-16 18:48:11', 54, 1),
(6, '3.2', 'insert localities table', 'SQL', 'V3_2__insert_localities_table.sql', 805785997, 'root', '2022-06-16 18:48:11', 6, 1),
(7, '4.1', 'create roles table', 'SQL', 'V4_1__create_roles_table.sql', 239598783, 'root', '2022-06-16 18:48:11', 51, 1),
(8, '4.2', 'insert roles table', 'SQL', 'V4_2__insert_roles_table.sql', -1624113663, 'root', '2022-06-16 18:48:11', 7, 1),
(9, '5.1', 'create locations table', 'SQL', 'V5_1__create_locations_table.sql', 1736301610, 'root', '2022-06-16 18:48:11', 254, 1),
(10, '5.2', 'insert locations table', 'SQL', 'V5_2__insert_locations_table.sql', -24996490, 'root', '2022-06-16 18:48:11', 6, 1),
(11, '6.1', 'create shows table', 'SQL', 'V6_1__create_shows_table.sql', -709360463, 'root', '2022-06-16 18:48:12', 230, 1),
(12, '6.2', 'insert shows table', 'SQL', 'V6_2__insert_shows_table.sql', 889005485, 'root', '2022-06-16 18:48:12', 4, 1),
(13, '7.1', 'create representations table', 'SQL', 'V7_1__create_representations_table.sql', -1242905365, 'root', '2022-06-16 18:48:12', 274, 1),
(14, '7.2', 'insert representations  table', 'SQL', 'V7_2__insert_representations _table.sql', -449713261, 'root', '2022-06-16 18:48:12', 4, 1),
(15, '8.1', 'create artist type table', 'SQL', 'V8_1__create_artist_type_table.sql', 1676507029, 'root', '2022-06-16 18:48:12', 395, 1),
(16, '8.2', 'insert artist type table', 'SQL', 'V8_2__insert_artist_type_table.sql', -1003207613, 'root', '2022-06-16 18:48:12', 4, 1),
(17, '9.1', 'create artist type show table', 'SQL', 'V9_1__create_artist_type_show_table.sql', -423954201, 'root', '2022-06-16 18:48:13', 247, 1),
(18, '9.2', 'insert artist type show table', 'SQL', 'V9_2__insert_artist_type_show_table.sql', -31123080, 'root', '2022-06-16 18:48:13', 14, 1),
(19, '10.1', 'create users table', 'SQL', 'V10_1__create_users_table.sql', 513360628, 'root', '2022-06-16 18:48:13', 47, 1),
(20, '10.2', 'insert users table', 'SQL', 'V10_2__insert_users_table.sql', -297260466, 'root', '2022-06-16 18:48:13', 7, 1),
(21, '11.1', 'create user role table', 'SQL', 'V11_1__create_user_role_table.sql', -330443967, 'root', '2022-06-16 18:48:13', 457, 1),
(22, '11.2', 'insert user role table', 'SQL', 'V11_2__insert_user_role_table.sql', 425274378, 'root', '2022-06-16 18:48:13', 7, 1),
(23, '12.1', 'create reservations table', 'SQL', 'V12_1__create_reservations_table.sql', 1726137537, 'root', '2022-06-16 18:48:14', 454, 1),
(24, '12.2', 'insert reservations table', 'SQL', 'V12_2__insert_reservations_table.sql', 2074592799, 'root', '2022-06-16 18:48:14', 4, 1),
(25, '13.1', 'create category table', 'SQL', 'V13_1__create_category_table.sql', 2021239037, 'root', '2022-06-16 18:48:14', 54, 1),
(26, '13.2', 'insert category table', 'SQL', 'V13_2__insert_category_table.sql', 1123599986, 'root', '2022-06-16 18:48:14', 4, 1),
(27, '14.1', 'create rooms table', 'SQL', 'V14_1__create_rooms_table.sql', -2103888250, 'root', '2022-06-16 18:48:14', 49, 1),
(28, '14.2', 'insert rooms table', 'SQL', 'V14_2__insert_rooms_table.sql', 173819985, 'root', '2022-06-16 18:48:14', 4, 1);
...
(1, 1, 4, '2012-10-12 13:30:00.000000'),
(2, 3, 1, '2012-10-12 20:30:00.000000'),
(3, 2, 2, '2012-10-02 20:30:00.000000'),
(4, 1, 3, '2012-10-16 20:30:00.000000');
...
INSERT INTO `shows` (`id`, `slug`, `title`, `description`, `poster_url`, `bookable`, `price`, `created_at`, `updated_at`, `location_id`, `category_id`) VALUES
(1, 'ayiti', 'Ayiti', 'Un homme est bloqué à l’aéroport.\n Questionné par les douaniers, il doit alors justifier son identité, et surtout prouver qu\'il est haïtien – qu\'est-ce qu\'être haïtien ?', 'ayiti.jpg', 1, '9.00', '2020-04-21 19:08:44.583000', NULL, 1, 3),
(2, 'cible-mouvante', 'Cible mouvante', 'Dans ce « thriller d’anticipation », des adultes semblent alimenter et véhiculer une crainte féroce envers les enfants âgés entre 10 et 12 ans.', 'cible.jpg', 1, '9.00', '2020-04-21 19:08:53.156000', NULL, 2, 4),
(3, 'ceci-nest-pas-un-chanteur-belge', 'Ceci n\'est pas un chanteur belge', 'Non peut-être ?!\nEntre Magritte (pour le surréalisme comique) et Maigret (pour le réalisme mélancolique), ce dixième opus semalien propose quatorze nouvelles chansons mêlées à de petits textes humoristiques et à quelques fortes images poétiques.', 'claudebelgesaison220.jpg', 1, '5.50', '2020-04-21 19:08:53.189000', '2020-04-21 19:08:53.189000', NULL, 1),
(4, 'manneke', 'Manneke… !', 'A tour de rôle, Pierre se joue de ses oncles, tantes, grands-parents et surtout de sa mère.', 'wayburn.jpg', 1, '10.50', '2020-04-21 19:09:02.426000', '2020-04-21 19:09:02.426000', 3, 1);
...
--
ALTER TABLE `rooms`
  ADD CONSTRAINT `room_id` FOREIGN KEY (`location_id`) REFERENCES `locations` (`id`);
